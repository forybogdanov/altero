...
import notspecs from "./notspecs.svg"
import analyticsEmpty from './analyticsEmpty.svg'
            ...
            <div style={{backgroundColor:"#f7f7f7" ,fontFamily:"Montserrat"}}>
                <Grid container spacing={3}>
                    ...
                    <Grid item xs={7}>
                        ...
                        <div>
                            <img src={header} style={{width: "90vw",position:"relative",zIndex: "1", paddingLeft:"50px", cursor:"pointer"}}/>
                        ...
                        <img src={notspecs} style={{marginTop:"505px", paddingLeft:"140px"}}/>
                    </Grid>
